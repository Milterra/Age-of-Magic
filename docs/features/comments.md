...
![giscus-example](docs/images/giscus-example.png)
...
First, make sure that the [GitHub](docs/setting%20up%20your%20GitHub%20repository.md) repository you are using for your Quartz meets the following requirements:
...
![giscus-repo](docs/images/giscus-repo.png)

![giscus-discussion](docs/images/giscus-discussion.png)
...
![giscus-results](docs/images/giscus-results.png)
