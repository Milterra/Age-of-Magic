...
Syntax highlighting is a functionality of the [SyntaxHighlighting](docs/plugins/SyntaxHighlighting.md) plugin. See the plugin page for customization options.
