...
This functionality is provided by the [OxHugoFlavoredMarkdown](docs/plugins/OxHugoFlavoredMarkdown.md) plugin. See the plugin page for customization options.
